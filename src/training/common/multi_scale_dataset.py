...
class MultiScaleDataset(Dataset):
    ...
    def __init__(
        ...
        logger.info(
            f"MultiScaleDataset: scales={scales}, augment={augment}, "
            ...
            if self.augment:
                transform_list.extend(
                    [
                        ...
                        # Color jitter removed (opt-in only, default OFF for physics integrity)
                    ]
                )

            # Convert to tensor and normalize with astronomy default
            transform_list.extend(
                [
                    T.ToTensor(),
                    T.Normalize(
