...
def create_parser() -> argparse.ArgumentParser:
    ...
    benchmark_parser = subparsers.add_parser(
        "benchmark-attn", help="Benchmark attention mechanisms"
    )
...
def add_eval_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--weights", type=str, help="Path to model weights (single mode)"
    )
    parser.add_argument(
        "--arch", type=str, default="resnet18", help="Model architecture (single mode)"
    )
...
def add_benchmark_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--batch-size", type=int, default=32, help="Batch size for benchmarking"
    )
    parser.add_argument(
        "--img-size", type=int, default=112, help="Image size for models"
    )
    parser.add_argument(
        "--num-samples",
        type=int,
...
def run_benchmark(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        sys.argv = [
            ...
            "--baseline-architectures",
            args.baseline_architectures,
            "--classical-methods",
            args.classical_methods,
            "--data-root",
            args.data_root,
            "--batch-size",
            str(args.batch_size),
